...
Simple backend learning project built while following the Udemy course.

## Course
- [Backend Engineering with Go](https://www.udemy.com/course/backend-engineering-with-go/)
